...
| ---------- | --------------- | -------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `env`      | string          | `optional`     | Can be `"production"` or `"development"`. Production uses the main Ethereum network and Development uses the Rinkeby test network. If not specified, this value defaults to `"production"` |
